...
public class EmployeeDAO {
    public JSONArray getEmployeeByName(String firstName, String lastName) {
        ...
        String result = Reseau.webServiceResponse(nameValuePairs, "http://10.0.2.2/smartphone/employeeDataManager/getEmployeeByName.php");
    ...
    public String getEmployeeFullNameById(String id) {
        ...
        String result = Reseau.webServiceResponse(nameValuePairs, "http://10.0.2.2/smartphone/employeeDataManager/getEmployeeById.php");
